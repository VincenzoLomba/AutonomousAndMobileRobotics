...
# =====================================================
# | A simple .sh file to correctly source ROS2 Humble |
# =====================================================
...
export PYTHONPATH=/home/vincenzo/Documenti/AMR/ros2pythonvenv/lib/python3.10/site-packages:$PYTHONPATH # Override the Python path with the one of the local environment

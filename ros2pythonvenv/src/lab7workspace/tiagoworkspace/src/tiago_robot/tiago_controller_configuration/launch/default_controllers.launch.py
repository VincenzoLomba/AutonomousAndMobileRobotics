...
def generate_launch_description():
    ...
    arm_controller_2_launch = include_launch_py_description(
        'tiago_controller_configuration',
        ['launch', 'arm2_controller.launch.py'],
        condition=LaunchConfigurationNotEquals('arm', 'no-arm'))
        
    arm_position_controller_launch = include_launch_py_description(
        'tiago_controller_configuration',
        ['launch', 'arm_position_controller.launch.py'],
        condition=LaunchConfigurationNotEquals('arm', 'no-arm'))
        
    test_pid_controller_launch = include_launch_py_description(
        'tiago_controller_configuration',
        ['launch', 'test_pid_controller.launch.py'],
        condition=LaunchConfigurationNotEquals('arm', 'no-arm'))
